...
import EmployeeSetupPage from './global_pages/EmployeeSetupPage'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/update-account" element={<EmployeeSetupPage />} />
        <Route path="/update-account/:userId" element={<EmployeeSetupPage />} />
